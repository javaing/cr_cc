...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = ReaderApplication.Companion.getInstance().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = ReaderApplication.Companion.getInstance().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics =  ReaderApplication.Companion.getInstance()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
