...
@Route(path = Path.PATH_WEB_FRAGMENT2)
open class BaseWebFragment2 : BaseFragment(), FragmentBackHandler {
    ...
    private fun isSchemeInWhiteList(url: String): Boolean {
        ...
        Log.d("tag","isSchemeInWhiteList:$list")
        for (scheme in list) {
...
////                    referer ="http://www.178fu.cn/"
//                    view.loadUrl(url, mutableMapOf("Referer" to referer))
////                    var urldata : String = ""
////                    view.loadData(urldata, "text/html; charset=utf-8", "UTF-8");
//
//                } else {
//                    view.loadUrl(url)
//                }
