...
public class VodControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener, IGestureComponent {
    ...
    public void setProgress(int duration, int position) {
        Log.d("progress","duration:"+duration+",position："+position);
        if (mIsDragging) {
            return;
        }
    ...
    public void onPositionChange(int slidePosition, int currentPosition, int duration) {
        ...
        mBottomProgress.setProgress(pos);
        Log.d("onPositionChange","pos:"+pos+",slidePosition:"+slidePosition+",currentPosition:"+currentPosition+",duration:"+duration);
    }
